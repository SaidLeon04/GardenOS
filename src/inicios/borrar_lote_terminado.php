...
<script type="text/javascript">
    ...
    var respuesta = confirm("¿Eliminar Lote?, Esta accion elimina todo registro del lote en cuestión ¿continuar?");
    if (respuesta == true) {
        return true;
    }else{
        return false;
...
<div class="container">
    <h1>Eliminar</h1>
    <form action="borrar_lote_terminado_action.php" method="POST">
        <?php 
            include("../conexion.php");
            $id_lote = $_GET['id_lote'];
        ?>
        <input type="number" name="id_lote" readonly value="<?php echo $id_lote?>" hidden>
        <input type="text" name="nombre_lote" placeholder="Nombre del lote">
        <label>Esta acción eliminar definitivamente un lote</label><br><br>
        <label>Todo registro del lote quedara eliminado, registros de riegos, temperatura, estado, etc.</label><br><br>
        <input type="submit" name="eliminar" value="Eliminar" onclick="return eliminarLote()">
    </form>
</div>
</body>
