...
if(isset($_POST['eliminar'])){
    ...
    $consulta_nombre_lote = "SELECT nombre_lote FROM lotes_terminados WHERE nombre_lote = '$nombre_lote'";
    ...
    if($validez_nombre){
        ...
        $consulta_terminados = "DELETE  FROM lotes_terminados WHERE id_lote = '$id_lote'";
        $consulta = "DELETE  FROM lote WHERE id_lote = '$id_lote'";
            ...
            $resultado_terminados = mysqli_query($conexion,$consulta_terminados);

            $resultado = mysqli_query($conexion,$consulta);

            if ($resultado && $resultado_riegos && $resultado_temperatura && $resultado_humedad && $resultado_iluminacion && $resultado_poda  && $resultado_cambio_tierra  && $resultado_historial &&  $resultado_crecimiento &&  $resultado_plagas && $resultado_terminados) {
                header("Location: ../inicios/lotes_terminados.php"); 
            }else{
                echo "error";
            }
    }else{
