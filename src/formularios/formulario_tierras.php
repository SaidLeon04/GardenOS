...
<head>
    ...
    <style>
        .container {
            ...
            animation: fade 1s;
            background-image: linear-gradient(to bottom, #F8C471, #FEF5E7);
        }
        ...
        input[type="submit"]:focus, 
{
        ...
        input[type="submit"] {
            ...
            padding: 10px 20px;
            font-size: 16px;
            background-image: linear-gradient(to right, #F8C471, #000000);
            color: white;
            cursor: pointer;
            transition: background-color 0.3s ease, transform 0.3s ease;
            width: 100%;
        ...
        input[type="submit"]:hover {
            background-image: linear-gradient(to right, #000000, #F8C471);
...
<div class="container">
    <h1>CAMBIO DE TIERRA</h1>
    <form action="formulario_tierras_action.php" method="POST">
        <?php 
            include("../conexion.php");
        ...
        <input type="number" placeholder="Cantidad Tierra KG" name="cantidad_tierra" min="1" max="1000">
        <input type="submit" name="guardar" value="Guardar">
        <input type="submit" name="ahora" value="Fecha actual">
    </form>
</div>
