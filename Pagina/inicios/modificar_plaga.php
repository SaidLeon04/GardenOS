...
<div class="container">
    <h1>PLAGAS</h1>
    <form action="modificar_plaga_action.php" method="POST" enctype="multipart/form-data">
        <?php
            $id_plaga = $_GET['id_plaga'];
            $nombre_plaga = $_GET['nombre_plaga'];
            $tratamiento = $_GET['tratamiento'];
            $afectaciones = $_GET['afectaciones'];
            $causas = $_GET['causas'];
                $consulta = 'SELECT id_lote, nombre_lote FROM lote';
                $resultado = mysqli_query($conexion,$consulta);
        ?>
        <input type="text" name="id_plaga" hidden readonly value="<?php echo $id_plaga ?>">
        <input type="text" placeholder="Nombre plaga" name="nombre" value="<?php echo $nombre_plaga ?>">


            <input type="text" placeholder="Tratamiento" name="tratamiento" value="<?php echo $tratamiento ?>">
            <input type="text" placeholder="Afectaciones" name="afectaciones" value="<?php echo $afectaciones ?>">
            <input type="text" placeholder="Causas" name="causas" value="<?php echo $causas ?>">
