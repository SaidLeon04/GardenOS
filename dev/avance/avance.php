...
<head>
    ...
    <link rel="stylesheet" href="/proyectos/garden_os/dev/avance/css/avance.css">
    <title>Avanzar un paso</title>
        ...
        <center>
            <div class="form-info">
                ...
                <div class="info">
                    ...
                    <div>
                        <h3>Datos nuevos: </h3>
                        <form id="avance" method=POST action="/proyectos/garden_os/avance_action">
                ...
                <div class="actions">
                        ...
                        <button class="delete-button" type="button"><a href="/proyectos/garden_os/dashboard?id_lote=<?php echo $id_lote ?>">Volver</a></button>
