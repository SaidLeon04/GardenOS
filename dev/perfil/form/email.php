            ...
            <div class="form-info">
                <div class="info">
                    <img src="data:image;base64,<?php echo $imagen; ?>" alt="imagen_usuario" id="imagen_usuario">
                        ...
                        <form id="usuario" enctype="multipart/form-data" method=POST action="/proyectos/garden_os/email_action">
                        ...
                        <label for="new_emailr" class="text">Repite correo nuevo: </label>
                            <input type="email" id="new_emailr" name="new_emailr">
                            <br>
                </div>
                <div class="actions">
                        <button class="create-button" id="btn-guardar" onclick="return changeCorreo()" type="submit">Guardar</button>
                        <button class="delete-button" id="btn-cancel" type="button" ><a href="/proyectos/garden_os/perfil">Cancelar</a></button>
                    </form>
                </div>    
            </div>
        </center>
